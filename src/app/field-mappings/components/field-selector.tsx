...
export const FieldSelector = memo(function FieldSelector({
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex flex-col max-h-[200px] overflow-y-auto p-2 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
          ...
          {filteredFields.map((field) => (
            ...
            >
              <label className="flex items-center gap-2 cursor-pointer flex-1">
                ...
                />
                <span className="text-sm text-gray-900 dark:text-gray-100 truncate" title={field.name}>
                  {field.name}
                </span>
              </label>
            </div>
